...
import AddCardIcon from '../../../../assets/icons/stream/addCard.svg';
import VideoLibraryIcon from '../../../../assets/icons/stream/videoLibrary.svg';
...
export const StreamActionRail: React.FC<StreamActionRailProps> = ({
  ...
  return (
    <View style={styles.rail}>
      ...
      {/* Figma no dibuja mute/unmute: el par Volume2/VolumeX se queda en lucide
          para no romper el indicador de audio silenciado. */}
      <StreamIconButton
